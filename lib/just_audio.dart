...
class AudioPlayer {
  ...
  Future<Duration> setUrl(final String url, final int cacheMax) async {
    final String cacheDir = (await getApplicationDocumentsDirectory()).path;
    _durationFuture = _invokeMethod('setUrl', [url, cacheDir, cacheMax])
