...
class MethodChannelAudioPlayer extends AudioPlayerPlatform {
  ...
  Future<SetBoostVolumeResponse> setBoostVolume(SetBoostVolumeRequest request) async {
    return SetBoostVolumeResponse.fromMap((await _channel
        .invokeMethod<Map<dynamic, dynamic>>('setBoostVolume', request.toMap()))!);
  }

  @override
  Future<SetSkipSilenceResponse> setSkipSilence(SetSkipSilenceRequest request) async {
    return SetSkipSilenceResponse.fromMap((await _channel
        .invokeMethod<Map<dynamic, dynamic>>('setSkipSilence', request.toMap()))!);
  }
  @override
